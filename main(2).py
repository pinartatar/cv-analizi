...
# ─────────────────────────────────────────────────────────────────────────────
#  FONT AYARI — Türkçe karakter desteği, platform bağımsız
#
#  Strateji: matplotlib her platforma (Mac, Windows, Linux) DejaVu Sans
#  fontlarını kendi paketi içinde getiriyor. Ekstra kurulum gerektirmez.
# ─────────────────────────────────────────────────────────────────────────────
...
def _setup_turkish_font():
    ...
    candidates = [
        # matplotlib içi — her platformda kesinlikle var
...
# Türkçe görünen adlar (PDF'te gösterilecek)
role_display = {
...
async def analyze_cv(file: UploadFile):
    ...
    try:
        ...
        # Frontend'e gönderilen rol adları Türkçe olsun
        return {
